...
(function () {
  ...
  var css = [
    ...
    "#hmp-avatar{width:56px;height:56px;border-radius:50%;background-size:cover;background-position:52% 25%;background-color:#e5e7eb;overflow:hidden;position:relative;box-shadow:inset 0 -8px 18px rgba(0,0,0,.12)}",
